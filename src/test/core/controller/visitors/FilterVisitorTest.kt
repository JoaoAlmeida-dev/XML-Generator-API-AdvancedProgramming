...
internal class FilterVisitorTest {
    lateinit var originalxmldoc: XMLDocument
    ...
    internal fun setUp() {
        ...
        originalxmldoc = XMLDocument(entity = entity, header = XmlHeader(version = 1.0))
    }
    ...
    fun visit() {
        ...
        assertNotEquals(filterVisitor.document, originalxmldoc)

        println(filterVisitor.document)
        println(originalxmldoc)
